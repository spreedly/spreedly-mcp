...
const purchaseFollowedByRecache: Scenario = {
  ...
  description:
    "When told to recache CVV and then charge, the AI must sequence recache before purchase.",
...
export const multiStepWorkflows: Scenario[] = [purchaseFollowedByRecache];
