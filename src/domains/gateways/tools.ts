...
export const gatewayTools: ToolDefinition[] = [
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_type, credentials } = params as { gateway_type: string; credentials?: Record<string, unknown> };
  ...
  },
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_token, credentials } = params as { gateway_token: string; credentials?: Record<string, unknown> };
  ...
  },
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_token, since_token, order } = params as { gateway_token: string; since_token?: string; order?: string };
      const query = buildQuery({ since_token, order });
      const res = await transport.request("GET", `/gateways/${gateway_token}/transactions.json${query}`);
      return res.data;
    },
  },
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_token, ...txnParams } = params as Record<string, unknown> & { gateway_token: string };
      const body = { transaction: txnParams };
      const res = await transport.request("POST", `/gateways/${gateway_token}/authorize.json`, { body });
      return res.data;
    },
  },
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_token, ...txnParams } = params as Record<string, unknown> & { gateway_token: string };
      const body = { transaction: txnParams };
      const res = await transport.request("POST", `/gateways/${gateway_token}/purchase.json`, { body });
      return res.data;
    },
  },
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_token, ...txnParams } = params as Record<string, unknown> & { gateway_token: string };
      const body = { transaction: txnParams };
      const res = await transport.request("POST", `/gateways/${gateway_token}/verify.json`, { body });
      return res.data;
    },
  },
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_token, payment_method_token } = params as { gateway_token: string; payment_method_token: string };
      const body = { transaction: { payment_method_token } };
      const res = await transport.request("POST", `/gateways/${gateway_token}/store.json`, { body });
      return res.data;
    },
  },
  {
    ...
    handler: async (params, { transport }) => {
      const { gateway_token, ...txnParams } = params as Record<string, unknown> & { gateway_token: string };
      const body = { transaction: txnParams };
      const res = await transport.request("POST", `/gateways/${gateway_token}/general_credit.json`, { body });
      return res.data;
    },
  },
];
