...
export const ShowGatewaySchema = z.object({
...
export const RetainGatewaySchema = z.object({
  gateway_token: z.string().describe("The token of the gateway to retain"),
}).strict();

export const ListGatewayTransactionsSchema = z.object({
...
export const GatewayAuthorizeSchema = z.object({
...
export const GatewayPurchaseSchema = z.object({
  gateway_token: z.string().describe("The token of the gateway"),
...
export const GatewayVerifySchema = z.object({
  gateway_token: z.string().describe("The token of the gateway"),
  payment_method_token: z.string().describe("The token of the payment method"),
  currency_code: z.string().length(3).describe("ISO 4217 currency code"),
  retain_on_success: z.boolean().optional().describe("Whether to retain the payment method on success"),
...
export const GatewayStoreSchema = z.object({
  gateway_token: z.string().describe("The token of the gateway"),
  payment_method_token: z.string().describe("The token of the payment method"),
}).strict();

export const GatewayGeneralCreditSchema = z.object({
  gateway_token: z.string().describe("The token of the gateway"),
