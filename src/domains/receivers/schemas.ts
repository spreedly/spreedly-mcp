  ...
  .object({
    receiver: z.object({
      ...
      credentials: z
        ...
        .optional()
        .describe("Receiver credentials"),
    }),
  })
  .strict();

export const ListReceiversSchema = z
  .object({
...
export const ShowReceiverSchema = z
  .object({
...
export const RedactReceiverSchema = z
  .object({
    receiver_token: z.string().describe("The token of the receiver to redact"),
  })
  .strict();

export const DeliverReceiverSchema = z
  .object({
    receiver_token: z.string().describe("The token of the receiver"),
...
export const ExportReceiverSchema = z
  .object({
    receiver_token: z.string().describe("The token of the receiver"),
